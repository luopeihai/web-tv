    ...
    renderCastItem = (item: any, index: number) => {
        ...
        return <div key={index} className="col-md-4 cast-item">
            <div className="cast-item-img">
                <img src={image?.medium} alt="cast-image" />
            </div>
            <div className="cast-item-right" >
                <a href={url} target="_blank" className="name"  > {name}</a>
                <p>
                    as <a href={roleUrl} target="_blank">{roleName}</a>
                </p>
            </div>
                    ...
                    <div className="right-box">
                        ...
                        }
                        {
                            detail.officialSite && <p className="">
                                ...
                                <a target="_blank" href={detail.officialSite}> link  <AiOutlineLink /></a>
                            </p>
